...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('ContentTexts', [
      ...
      { languageid: 1, contentid: 2, text: 'A Single Page Application built using Angular and Nodejs' },
      ...
      { languageid: 2, contentid: 2, text: 'Application d\'une seule page utilisant node et angular' },
